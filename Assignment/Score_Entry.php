...
header("location:?tag=view_scores");
	...
	<div id='top_style_button'> 
       		<form method='post'>
            	<a href='?tag=view_scores'><input type='button' name='btn_back' value='View Scores' id='button_view' style='width:120px;'  /></a>
       		</form>
		</div>");
}
else{
    exit(header("Location:?tag=view_scores"));
}
}
?>
	...
	<form method="post">
    	...
    	<table border="0" cellpadding="5" cellspacing="0">
            ...
            <tr>
            	<td>Midterm</td>
            	<td>
                	<input type="text" name="midermtxt" id="textbox" value="<?php echo $rs_upd['miderm'];?> " pattern="[0-9]{0,2}" maxlength="2" placeholder="Out of 100" required/>
                </td>
            </tr>
            ...
            <tr>
            	<td>Final</td>
                <td>
                	<input type="text" name="finaltxt"  id="textbox" value="<?php echo $rs_upd['final'];?>" pattern="[0-9]{0,2}" maxlength="2" placeholder="Out of 100" required/>
                </td>
            </tr>
            ...
            <tr>
            	<td>Note</td>
                <td>
                	<textarea name="notetxt" cols="23" rows="3" required><?php echo $rs_upd['note'];?></textarea>
                </td>
            </tr>
	...
	<form method="post">
    	...
    	<table border="0" cellpadding="5" cellspacing="0">
            ...
            <tr>
            	<td>Midterm</td>
            	<td>
                	<input type="text" name="midermtxt" id="textbox" pattern="[0-9]{0,2}" maxlength="2" placeholder="Out of 100" required/>
                </td>
            </tr>
            ...
            <tr>
            	<td>Final</td>
                <td>
                	<input type="text" name="finaltxt"  id="textbox" pattern="[0-9]{0,2}" maxlength="2" placeholder="Out of 100" required/>
                </td>
            </tr>
