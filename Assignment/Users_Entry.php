...
if(isset($_POST['btn_upd'])){
	...
	<link rel='stylesheet' type='text/css' href='css/style_entry.css' />
	       <div id='top_style_button'> 
       		<form method='post'>
            	<a href='?tag=view_users'><input type='button' name='btn_view' value='View Users'  title='Back' id='button_view' style='width:100px;'  /></a>
       		</form>
       </div>");
}
else{
    exit(header("location:?tag=view_users"));
}
		//break;
}?>
	...
	<form method="post" name="registration" onSubmit="return formValidation()">
    	...
    	<table border="0" cellpadding="4" cellspacing="0">
            ...
            <tr>
            	<td>Username </td>
            	<td>
                	<input type="text" name="userid" id="textbox" value="<?php echo $rs_upd['username'];?>" required/>
                </td>
            </tr>
            ...
            <tr>
            	<td>Password</td>
            	<td>
                	<input type="password" name="passid" id="textbox" value="<?php  echo $rs_upd['password'];?>" required/>
                </td>
            </tr>
            ...
            <tr>
            	<td>Type</td>
            	<td>
                	<input type="text" name="typetxt" id="textbox"  value="<?php echo $rs_upd['type'];?>" required/>
                </td>
            </tr>
            ...
            <tr>
            	<td>Note</td>
                <td>
                	<textarea name="notetxt" cols="23" rows="5" required><?php echo $rs_upd['note'];?></textarea>
                </td>
            </tr>
	...
	<form method="post" name="registration" onSubmit="return formValidation()">
    	...
    	<table border="0" cellpadding="4" cellspacing="0">
            ...
            <tr>
            	<td>Username </td>
            	<td>
                	<input type="text" name="userid" id="userid1" required/>
                </td>
            </tr>
            ...
            <tr>
            	<td>Type</td>
            	<td>
                	<input type="text" name="typetxt" id="textbox" required/>
                </td>
            </tr>
            ...
            <tr>
            	<td>Note</td>
                <td>
                	<textarea name="notetxt" cols="23" rows="5" required/></textarea>
                </td>
            </tr>
