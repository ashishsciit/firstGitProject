...
if (headers_sent()) {
	...
	<div id='top_style_button'> 
       		<form method='post'>
            	<a href='?tag=view_subjects'><input type='button' name='btn_back' value='View Subjects' id='button_view' style='width:120px;'  /></a>
       		</form>
		</div>");
}
else{
    exit(header("Location:?tag=view_subjects"));
}
}
?>
	...
	<form method="post">
    	<div>
            ...
            <tr>
            	<td>Semester</td>
            	<td>
                	<input type="text" name="semestertxt" id="textbox" value="<?php echo $rs_upd['semester'];?>" pattern="[0-9]{1}" maxlength="1"  reqiuired/>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                	<input type="text" name="subtxt"  id="textbox" value="<?php echo $rs_upd['sub_name'];?>" required/>
                </td>
            </tr>
	...
	<form method="post">
    	<div>
            ...
            <tr>
            	<td>Semester</td>
            	<td>
                	<input type="text" name="semestertxt" id="textbox" maxlength="1" pattern="[0-9]{1}" required/>
                </td>
            </tr>
            ...
            <tr>
            	<td>Subjects's name</td>
                <td>
                	<input type="text" name="subtxt"  id="textbox" required/>
                </td>
            </tr>
