...
body {
	background-image: url(image/portfolio-3.jpg)!important;	
}
...
<body style="background-image : url(image/bg-6.jpg);background-posion:center center;background-repeat: no-repeat;background-size: cover;background-attachment: fixed;background-color: blueviolet;">
    <div class="wrapper">
